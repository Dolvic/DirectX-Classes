...
class InputElement
{
	...
	public:
		InputElement();
		InputElement(D3D11_INPUT_ELEMENT_DESC descriptor);
		InputElement(const char* elementName, int elementIndex, DXGI_FORMAT format, int inputSlot, int byteOffset, bool perVertex, int stepRate);
